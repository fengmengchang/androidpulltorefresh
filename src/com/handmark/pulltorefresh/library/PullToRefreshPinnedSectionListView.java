...
public class PullToRefreshPinnedSectionListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	protected ListView createListView(Context context, AttributeSet attrs) {
		...
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			lv = new PinnedSectionListViewSDK9(context, attrs);
		} else {
	...
	public class PinnedSectionListViewSDK9 extends InternalListViewSDK9 {
		...
		public PinnedSectionListViewSDK9(Context context, AttributeSet attrs) {
			super(context, attrs);
			initView();
		}

		public PinnedSectionListViewSDK9(Context context, AttributeSet attrs, int defStyle) {
			super(context, attrs, defStyle);
			initView();
		}
		...
		public void initShadow(boolean visible) {
			if (visible) {
				if (mShadowDrawable == null) {
					mShadowDrawable = new GradientDrawable(android.graphics.drawable.GradientDrawable.Orientation.TOP_BOTTOM, new int[] { Color.parseColor("#00000000"), Color.parseColor("#00000000"),
		...
		void createPinnedShadow(int position) {
			...
			View pinnedView = getAdapter().getView(position, pinnedShadow.view, PinnedSectionListViewSDK9.this);
